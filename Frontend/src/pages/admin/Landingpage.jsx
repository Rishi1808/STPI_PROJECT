...
//         <div className="h-[250px] w-[250px] bg-white flex items-center justify-center border border-gray-300 rounded-[50%] mx-auto">
...
//       <h2 className="text-lg text-white font-semibold mb-2 text-center">ADMIN PANNEL</h2>
//         </div>
...
import { useContext } from "react";
import { AuthContext } from "../../context/AuthContext.jsx";
import Fromlist from "./Fromlist";  // Import the Fromlist component
...
const LandingPage = () => {
  ...
  return (
    <div className='sm:max-w-[90%] flex justify-around mx-auto my-[5vh] rounded-md gap-[2rem] sm:flex-nowrap flex-wrap'>
      ...
      <div className='w-[50%] h-auto bg-gray-900/10 p-4 rounded-lg shadow-md flex flex-col gap-4 border border-white/20'>
        ...
        <div className="bg-white p-4 rounded-md border border-gray-300">
          ...
          <p className="text-gray-700"><strong>Email:</strong> {user?.email || "N/A"}</p>
            ...
            <div className="w-[100%] h-auto bg-gray-900/10 p-4 rounded-lg shadow-md border border-white/20">
        <div className="bg-blue-500">
          <h2 className="text-lg font-semibold mb-2 text-center text-white">APPLIED LISTS</h2>
        </div>
        <p>Here you’ll see notices and notifications.</p>
        <Fromlist />
      </div>
      ...
      <div className="w-[100%] h-auto bg-gray-900/10 p-4 rounded-lg shadow-md border border-white/20">
        <div className="bg-blue-500">
          <h2 className="text-lg text-white font-semibold mb-2 text-center">ADMIN PANEL</h2>
        </div>
